...
| `ce08_character_arc` | `CE08_STORY_KG` | P1 | YES | CE08 | `apps/api/src/engines/adapters/ce08_character_arc.adapter.ts` | `tools/gate/gates/gate_ce08_character_arc.sh` | - | 角色弧光追踪 |
| `ce12_theme_extractor` | `NOVEL_ANALYSIS` | P1 | YES | CE12 | `apps/api/src/engines/adapters/ce12_theme_extractor.adapter.ts` | `tools/gate/gates/gate_ce12_theme_extractor.sh` | - | 主题基调提取 |
| `ce13_pacing_analyzer` | `NOVEL_ANALYSIS` | P1 | YES | CE13 | `apps/api/src/engines/adapters/ce13_pacing_analyzer.adapter.ts` | `tools/gate/gates/gate_ce13_pacing_analyzer.sh` | - | 节奏与张力分析 |
...
| `vg04_camera_path` | `VG_RENDER` | P1 | YES | VG04 | `apps/api/src/engines/adapters/vg04_camera_path.adapter.ts` | `tools/gate/gates/gate_p3_vg_batch_v1.sh` | - | 自动化相机运镜 |
| `vg05_vfx_compositor` | `VG_RENDER` | P1 | YES | VG05 | `apps/api/src/engines/adapters/vg05_vfx_compositor.adapter.ts` | `tools/gate/gates/gate_p3_vg_batch_v1.sh` | - | 特效合成引擎 |
