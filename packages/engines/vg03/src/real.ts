...
返回格式为 JSON：
{
  ...
  "reason": "为了营造一种..."
            ...
            console.warn(`[VG03] AI Lighting design failed, falling back to rule logic: ${error.message}`);
        }
    }
