...
-- CreateEnum
CREATE TYPE "JobType" AS ENUM ('SHOT_RENDER', 'NOVEL_ANALYSIS', 'CE06_NOVEL_PARSING', 'CE03_VISUAL_DENSITY', 'CE04_VISUAL_ENRICHMENT', 'CE01_REFERENCE_SHEET', 'CE02_IDENTITY_LOCK', 'CE05_DIRECTOR_CONTROL', 'CE07_STORY_MEMORY', 'CE08_STORY_KG', 'CE09_MEDIA_SECURITY', 'VIDEO_RENDER');
...
-- CreateEnum
CREATE TYPE "billing_status" AS ENUM ('pending', 'completed', 'failed');
...
CREATE TABLE "ShotJob" (
    ...
    CONSTRAINT "ShotJob_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "job_engine_bindings" ADD CONSTRAINT "job_engine_bindings_jobId_fkey" FOREIGN KEY ("jobId") REFERENCES "ShotJob"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ShotJob" ADD CONSTRAINT "ShotJob_episodeId_fkey" FOREIGN KEY ("episodeId") REFERENCES "episodes"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ShotJob" ADD CONSTRAINT "ShotJob_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "organizations"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ShotJob" ADD CONSTRAINT "ShotJob_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "projects"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ShotJob" ADD CONSTRAINT "ShotJob_sceneId_fkey" FOREIGN KEY ("sceneId") REFERENCES "scenes"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ShotJob" ADD CONSTRAINT "ShotJob_shotId_fkey" FOREIGN KEY ("shotId") REFERENCES "shots"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ShotJob" ADD CONSTRAINT "ShotJob_taskId_fkey" FOREIGN KEY ("taskId") REFERENCES "Task"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ShotJob" ADD CONSTRAINT "ShotJob_workerId_fkey" FOREIGN KEY ("workerId") REFERENCES "worker_nodes"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "assets" ADD CONSTRAINT "assets_createdByJobId_fkey" FOREIGN KEY ("createdByJobId") REFERENCES "ShotJob"("id") ON DELETE SET NULL ON UPDATE CASCADE;
