        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    e = engines_1[_i];
                    return [4 /*yield*/, prisma.engine.findUnique({
                            where: { engineKey: e.engineKey },
                        })];
                case 2:
                    engine = _a.sent();
                    if (!engine) return [3 /*break*/, 4];
                    return [4 /*yield*/, prisma.engine.update({
                            where: { engineKey: e.engineKey },
                            data: {
                                code: e.code,
                                name: e.name,
                ...
                case 3:
                    ...
                    engine = _a.sent();
                    console.log("\u2705 Updated engine: ".concat(engine.engineKey, " -> code: ").concat(e.code, " (").concat(e.name, ")"));
                    return [3 /*break*/, 6];
                case 4: return [4 /*yield*/, prisma.engine.create({
                        data: e,
                    })];
                case 5:
                    // 如果不存在，创建新记录
                    engine = _a.sent();
                    console.log("\u2705 Created engine: ".concat(engine.engineKey, " -> code: ").concat(e.code, " (").concat(e.name, ")"));
                    _a.label = 6;
                case 6:
                    _i++;
                    return [3 /*break*/, 1];
