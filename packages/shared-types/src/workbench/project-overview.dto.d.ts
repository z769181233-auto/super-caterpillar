export type BlockReasonCode = 'MISSING_NOVEL' | 'STRUCTURE_NOT_READY' | 'SCENE_MISSING_CHAR_BINDING' | 'SCENE_MISSING_LOCATION_BINDING' | 'SHOT_PLAN_NOT_READY' | 'ASSET_NOT_READY' | 'QUALITY_GATE_FAILED' | 'COST_LIMIT_EXCEEDED' | 'PERMISSION_DENIED';
export type StageKey = 'NOVEL_IMPORT' | 'STRUCTURE_ANALYSIS' | 'SCRIPT_SEMANTIC' | 'SHOT_PLANNING' | 'ASSET_GENERATION' | 'VIDEO_GENERATION' | 'COMPOSE_EXPORT';
