...
function getEnvNumber(key, defaultValue) {
  var value = getEnv(
    key,
    defaultValue === null || defaultValue === void 0 ? void 0 : defaultValue.toString()
  );
...
exports.env = {
  ...
  jobWorkerInterval: Number(
    (_a = process.env.JOB_WORKER_INTERVAL) !== null && _a !== void 0 ? _a : '5000'
  ), // 轮询间隔（毫秒），默认 5 秒
  jobWorkerBatchSize: Number(
    (_b = process.env.JOB_WORKER_BATCH_SIZE) !== null && _b !== void 0 ? _b : '10'
  ), // 每次处理的任务数，默认 10
  // Engine
  engineDefault: (_c = process.env.ENGINE_DEFAULT) !== null && _c !== void 0 ? _c : 'mock', // 默认使用的引擎
  engineRealHttpBaseUrl:
    (_d = process.env.ENGINE_REAL_HTTP_BASE_URL) !== null && _d !== void 0
      ? _d
      : 'http://localhost:8000', // 真实 HTTP 引擎基础 URL
  // HMAC Authentication
