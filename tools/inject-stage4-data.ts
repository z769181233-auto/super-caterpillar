...
async function main() {
    ...
    const updatedScene = await prisma.scene.update({
        ...
        data: {
            ...
            enrichedText: "【AI 增强】这是一个色彩斑斓的奇幻森林，空气中弥漫着发光的孢子。镜头缓缓推进，展现出微观世界的惊人细节..."
        }
    });

    console.log(`✅ Scene Updated: Visual Density = ${updatedScene.visualDensityScore}, Enriched = ${!!updatedScene.enrichedText}`);
