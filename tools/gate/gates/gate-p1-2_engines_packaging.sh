...
node -p "Object.keys(require('@scu/engines-ce03'))" 2>&1 | tee "../../$EVIDENCE_DIR/require_ce03.log"
node -p "Object.keys(require('@scu/engines-ce04'))" 2>&1 | tee "../../$EVIDENCE_DIR/require_ce04.log"
node -p "Object.keys(require('@scu/engines-ce06'))" 2>&1 | tee "../../$EVIDENCE_DIR/require_ce06.log"
popd >/dev/null
...
(
  ...
  node -e "require('./apps/workers/dist/apps/workers/src/main.js'); console.log('[OK] worker dist main required')"
) 2>&1 | tee "$EVIDENCE_DIR/require_worker_dist_main.log"
