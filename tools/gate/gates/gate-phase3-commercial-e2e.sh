...
generate_hmac_headers_lines() {
  ...
  node -e "
    ...
    process.stdout.write('X-SCU-API-KEY: ' + apiKey + '\n');
    process.stdout.write('X-SCU-NONCE: ' + nonce + '\n');
    process.stdout.write('X-SCU-TIMESTAMP: ' + timestamp + '\n');
    process.stdout.write('X-SCU-SIGNATURE: ' + signature + '\n');
  "
}
