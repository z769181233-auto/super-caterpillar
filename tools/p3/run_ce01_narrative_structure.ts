...
async function main() {
    ...
    try {
        ...
        if (!res1.output?.analysis.beats.includes('SETTING_ESTABLISHED')) throw new Error("Expected SETTING_ESTABLISHED");
        ...
        if (!res2.output?.analysis.beats.includes('INCITING_INCIDENT_PROBABLE')) throw new Error("Expected INCITING_INCIDENT_PROBABLE");
