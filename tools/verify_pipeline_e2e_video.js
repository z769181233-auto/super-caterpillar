...
async function verifyPipelineE2EVideo() {
    ...
    try {
        ...
        await prisma.project.create({ data: { id: projectId, name: 'Verify Pipeline Project', organizationId: orgId, ownerId: userId } });
    ...
    try {
        ...
        const expected = ['CE06_NOVEL_PARSING', 'CE03_VISUAL_DENSITY', 'CE04_VISUAL_ENRICHMENT', 'TIMELINE_RENDER', 'CE09_MEDIA_SECURITY'];
