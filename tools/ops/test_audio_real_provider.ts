...
async function test() {
    ...
    try {
        ...
        console.log(`Mode: ${resT1.signals.audio_mode}, Vendor: ${resT1.signals.audio_vendor || 'SILENT'}`);
        ...
        console.log(`Mode: ${resT3.signals.audio_mode}, Vendor: ${resT3.signals.audio_vendor}, RequestID: ${resT3.signals.audio_vendor_request_id}`);
        ...
        try {
            ...
            if (e.message !== 'AUDIO_VENDOR_API_KEY_NOT_CONFIGURED') throw new Error("Wrong error message");
