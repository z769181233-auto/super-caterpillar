...
async function main() {
    ...
    try {
        ...
        console.log(`  organizationMembers.length: ${userWithOrgMembers?.organizationMembers?.length ?? 0}`);
        ...
        console.log(`  User.memberships (Membership model): ${userWithMemberships?.memberships?.length ?? 0}`);
        console.log(`  User.organizationMembers (OrganizationMember model): ${userWithOrgMembers?.organizationMembers?.length ?? 0}`);
