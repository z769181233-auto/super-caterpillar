...
async function main() {
    ...
    const originalUrl = process.env.DATABASE_URL || 'postgresql://postgres:postgres@localhost:5432/super_caterpillar_dev';
    ...
    try {
        ...
        exec('pnpm prisma migrate deploy', { env: { DATABASE_URL: verifyUrl }, cwd: './packages/database' });
