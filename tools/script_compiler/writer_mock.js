...
const FORBIDDEN_WORDS = ["悲伤", "快乐", "愤怒", "压抑", "绝望", "幸福", "感动", "纠结", "尴尬", "温情", "温馨", "浪漫", "气氛", "矛盾", "内心", "情绪", "恐惧", "痛苦", "遗憾", "失落", "惊喜", "担忧", "疑惑", "困惑", "爱", "恨", "后悔", "感到"];

const PAYOFF_LIST = [
    "门锁弹开", "玻璃炸裂", "警报骤停", "照片掉落", "血点溅墙",
    "核心过载发出蓝光", "机械臂停止运作", "屏幕显示认证通过", "隐藏门缓缓开启"
];
...
function fillSkeleton(skeletonPath, outputPath) {
    ...
    skeleton.beats.forEach((beat, bIdx) => {
        ...
        for (let i = 1; i <= shotCount; i++) {
            ...
            const actionResult = generateStrategicAction(charBase.name, motif, i, bIdx, beatHistory.combos, episodeComboUsage);
