...
const OUTPUT_DIR = OUTPUT_DIR_ARG
  ? path.resolve(ROOT_DIR, OUTPUT_DIR_ARG)
  ...
  for (const file of files) {
    ...
    lines.forEach((lineContent, index) => {
      ...
      if (
        ...
        lineContent.includes('eslint-disable-next-line')
      ) {
        risks.push({
          file: relativePath,
          line: lineNum,
