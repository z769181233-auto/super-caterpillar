#!/usr/bin/env bash
# ==============================================================================
# [GATE] {{phase}}: CE02 Mother -> {{engineKey}} ({{sealLevel}})
...
EVID_DIR="${EVID_ROOT}/{{phase_slug}}_{{ts}}"
mkdir -p "${EVID_DIR}"
...
# ========== MAIN ==========
echo "--- [GATE] {{phase}}: {{engineKey}} ({{sealLevel}}) START ---"
...
sha256_sums
build_evidence_index
echo "--- [GATE] {{phase}} PASS ({{sealLevel}}) ---"
MD
