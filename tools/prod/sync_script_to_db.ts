...
const SCRIPT_PATH = '/Users/adam/.gemini/antigravity/brain/16e4ea89-d4cd-4742-9e47-adf1f9e977e2/EPISODE_1_SCRIPT.md';
    ...
    for (const sceneData of scenesToSync) {
        ...
        const newScene = await prisma.scene.create({
            data: {
                ...
                chapterId: refScene?.chapterId ? `${refScene.chapterId}-${sceneData.index}-sync` : undefined, // ChapterId usually unique
            }
        });
