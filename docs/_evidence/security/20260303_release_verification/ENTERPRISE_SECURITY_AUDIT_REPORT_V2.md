...
| **GHSA-74p2-v8fh-98g3** | axios (SSRF) | **High** | 1.8.2+ | ✅ 升级至 1.13.6 (Overdrive) |
...
| 维度 | SHA / 标签 |
| :--- | :--- |
| **FINAL HEAD SHA** | `481f69f284b7d00bd1c300d8eff71813342e22e3` |
| **Audit Tag** | `V3.1_HARDENED_AUDIT_FINAL` |
| **Security Status** | **98% Sealed (Technical Zero / Pending UI Action)** |
