...
**Concept**: We are building a _clean-room implementation_ using our own "parts" (code) based on public "blueprints" (papers).
...
2.  **"Independently Trained"**: Highlights that the _data_ (and thus the resulting specific weights) is our property.
