...
| `quality_prod_hook`         | QUALITY_SCORE             | REAL (Production)     | 0-cost audit                             | `QC%`                | `gate-quality-prod-hook.sh`         | `seal/p14_0_quality_prod_hook_20260123`        | **P14-0**: JobService Level Hook Integration. 默认 OFF (Flag)，灰度 ON；Gate 环境可同步。 |
