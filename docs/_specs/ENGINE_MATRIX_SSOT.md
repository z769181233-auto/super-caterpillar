...
| `ce07_memory_update`        | CE07_MEMORY_UPDATE        | REAL (Postgres)       | job (ledgered)                           | `CE%`                | `gate_ce07_memory_update.sh`             | `seal/ce07_memory_update_20260201`             | **NEW**: P1 Memory Consistency Engine                                                                                                                      |
| `shot_preview`              | SHOT_PREVIEW              | REAL (Redis+Render)   | redis/render                             | `CE%`                | `gate_shot_preview_fast.sh`              | `seal/shot_preview_fast_20260201_v2`           | **NEW**: P1 Fast Preview (<1s cache, 0 secret, Real File)                                                                                                  |
