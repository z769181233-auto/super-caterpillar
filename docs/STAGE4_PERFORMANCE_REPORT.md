...
_> Note: 15M run showed better memory stability due to JIT/GC warm-up during longer execution._
...
- **Conclusion**: The "Shredder" architecture becomes _more_ efficient as file size grows.
