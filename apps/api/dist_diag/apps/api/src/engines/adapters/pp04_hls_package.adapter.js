...
exports.PP04HLSPackageAdapter = void 0;
...
let PP04HLSPackageAdapter = class PP04HLSPackageAdapter extends pp_base_engine_1.PpBaseEngine {
    ...
    async processLogic(payload) {
        ...
        const outputDir = (0, path_1.join)(process.cwd(), `storage/pp/hls/${hash}`);
        (0, fs_1.mkdirSync)(outputDir, { recursive: true });
        const outputPath = (0, path_1.join)(outputDir, `index.m3u8`);
...
exports.PP04HLSPackageAdapter = PP04HLSPackageAdapter;
exports.PP04HLSPackageAdapter = PP04HLSPackageAdapter = __decorate([
...
//# sourceMappingURL=pp04_hls_package.adapter.js.map