...
class AuBaseEngine {
    ...
    constructor(name, redis, audit, cost) {
        ...
        this.audit = audit;
        this.cost = cost;
        this.logger = new common_1.Logger(`${AuBaseEngine.name}[${name}]`);
    }
    supports(engineKey) {
...
exports.AuBaseEngine = AuBaseEngine;
//# sourceMappingURL=au_base.engine.js.map