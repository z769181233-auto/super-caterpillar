...
async function waitForJobs(
  ...
  while (Date.now() - startTime < timeout) {
    ...
    console.log(`[E2E] Job 状态: PENDING=${statusCounts.PENDING}, RUNNING=${statusCounts.RUNNING}, SUCCEEDED=${statusCounts.SUCCEEDED}, FAILED=${statusCounts.FAILED}, RETRYING=${statusCounts.RETRYING}`);
...
async function triggerOrchestrator(app: any): Promise<void> {
  ...
  console.log(`[E2E] ✅ Orchestrator 调度完成: dispatched=${result.dispatched}, skipped=${result.skipped}, errors=${result.errors}`);
