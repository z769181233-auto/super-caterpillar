...
export class CharacterController {
  ...
  async update(@Param('characterId') characterId: string, @Body() dto: UpdateCharacterDto) {
  ...
  async getAppearances(@Param('characterId') characterId: string, @Query('limit') limit?: number) {
