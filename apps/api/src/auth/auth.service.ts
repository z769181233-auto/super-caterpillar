...
export class AuthService {
  ...
  async login(loginDto: LoginDto) {
    ...
    const organizationId = await this.getCurrentOrganization(user.id);
  ...
  private async generateAccessToken(userId: string, email: string, tier: string, organizationId: string | null) {
    const payload = {
      sub: userId,
      email,
      tier,
  ...
  private async generateRefreshToken(userId: string, email: string, tier: string, organizationId: string | null) {
    const payload = {
      sub: userId,
      email,
      tier,
