...
class VgBaseEngine {
    ...
    constructor(name, redis, audit, cost) {
        ...
        this.audit = audit;
        this.cost = cost;
        this.logger = new common_1.Logger(`${VgBaseEngine.name}[${name}]`);
    }
    supports(engineKey) {
...
exports.VgBaseEngine = VgBaseEngine;
//# sourceMappingURL=vg_base.engine.js.map