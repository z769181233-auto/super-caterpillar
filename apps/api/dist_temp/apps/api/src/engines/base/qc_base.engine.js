...
class QcBaseEngine {
    ...
    constructor(name, redis, audit, cost) {
        ...
        this.audit = audit;
        this.cost = cost;
        this.logger = new common_1.Logger(`${QcBaseEngine.name}[${name}]`);
    }
    supports(engineKey) {
...
exports.QcBaseEngine = QcBaseEngine;
//# sourceMappingURL=qc_base.engine.js.map