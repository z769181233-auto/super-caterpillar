...
exports.PP03WatermarkAdapter = void 0;
...
let PP03WatermarkAdapter = class PP03WatermarkAdapter extends pp_base_engine_1.PpBaseEngine {
    ...
    async processLogic(payload) {
        ...
        const outputDir = (0, path_1.join)(process.cwd(), 'storage/pp/watermark');
...
exports.PP03WatermarkAdapter = PP03WatermarkAdapter;
exports.PP03WatermarkAdapter = PP03WatermarkAdapter = __decorate([
...
//# sourceMappingURL=pp03_watermark.adapter.js.map