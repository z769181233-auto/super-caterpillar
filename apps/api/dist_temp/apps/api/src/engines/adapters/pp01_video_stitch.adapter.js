...
exports.PP01VideoStitchAdapter = void 0;
...
let PP01VideoStitchAdapter = class PP01VideoStitchAdapter extends pp_base_engine_1.PpBaseEngine {
    ...
    async processLogic(payload) {
        ...
        const outputDir = (0, path_1.join)(process.cwd(), 'storage/pp/stitch');
...
exports.PP01VideoStitchAdapter = PP01VideoStitchAdapter;
exports.PP01VideoStitchAdapter = PP01VideoStitchAdapter = __decorate([
...
//# sourceMappingURL=pp01_video_stitch.adapter.js.map