        ...
        <>
            ...
            <Card style={{ padding: '1.25rem' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', fontSize: '0.85rem' }}>
                    ...
                    <a href="#" style={{ color: 'var(--text-secondary)', textDecoration: 'none' }}>→ Platform Walkthrough</a>
                    <a href="#" style={{ color: 'var(--text-secondary)', textDecoration: 'none' }}>→ Evidence Index</a>
                </div>
            </Card>
        </>
    );
