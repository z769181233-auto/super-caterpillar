...
export const useStudioUiStore = create<OutlineState>()(
    persist(
        (set, get) => ({
            ...
            toggleExpanded: (nodeId, forceOpen) => set((state) => ({
                expandedNodeIds: {
            ...
            setActiveShot: (shotId, source) => set({
                activeShotId: shotId,
            ...
            setActiveNode: (nodeId, source) => set({
            ...
            setRolesCollapsed: (value, mode = 'manual') => set({
                rolesCollapsed: value,
                rolesCollapseMode: mode,
            }),
            togglePanel: (panelKey) => set((state) => ({
                collapsedPanels: {
