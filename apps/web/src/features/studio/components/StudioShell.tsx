      ...
      <div className="topBar">
        ...
        >
          <div className="brand" style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <span style={{ fontWeight: 800, letterSpacing: -0.5, fontSize: 16 }}>
              {t('studioBrand')}
            </span>
          </div>
        ...
        >
          <div>
            ...
            <div style={{ opacity: 0.5, fontSize: 13 }}>
              {summary.subtitle || t('enterWorkbench')}
            </div>
          </div>
          ...
          <AuditBadges
            ...
            isAudited={
              summary.auditStatus === 'AUDITED'
                ? true
                : summary.auditStatus != null
                  ? false
                  : summary.statusLabel === 'AUDITED'
                    ? true
