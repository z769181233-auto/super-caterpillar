...
const fetchLatestCommercialRun = async (): Promise<RunData | null> => {
  ...
  return {
    ...
    previewUrl:
      'previews/proj_seed_1768293088_14292/scene_seed_1768293088_14292/f60522dc-3492-4a78-b868-054f545153fd_preview.mp4',
            ...
            {run.engineChain.map((step, idx) => (
              ...
              >
                <div className="flex items-center">
                  <div
                    className={`w-2 h-2 rounded-full mr-2 ${step.status === 'SUCCESS' ? 'bg-green-500' : 'bg-red-500'}`}
                  />
        ...
        <div>
          ...
          <div className="bg-gray-50 rounded p-4 space-y-3">
            ...
            <div className="flex justify-between text-sm">
              ...
              <span
                className="font-mono text-xs overflow-hidden text-ellipsis w-48 block"
                title={run.evidencePath}
              >
                {run.evidencePath}
              </span>
            </div>
...
const ObservabilityPanel = () => {
  ...
  if (loading)
    return (
      <div className="p-4 bg-white rounded border animate-pulse h-32 mb-8">Loading Metrics...</div>
    );
      ...
      <div className="max-w-6xl mx-auto">
        <header className="mb-8">
          ...
          <p className="text-gray-600">
            Phase 4 Commercial Closure • Operations & Billing • Hard Sealed
          </p>
        </header>
        ...
        <section>
          ...
          {run ? (
            ...
            <div className="p-8 text-center text-gray-500">Loading Run Data...</div>
          )}
        </section>
      </div>
    </div>
