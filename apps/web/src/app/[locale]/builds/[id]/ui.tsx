...
import { BuildSummary, ScriptNode, InsightsPayload, ShotReaderPayload } from "@/features/studio/types";
import { fetchShotReader } from "@/features/studio/api";
import { StudioShell } from "@/features/studio/components/StudioShell";

export default function BuildStudioClient(props: { summary: BuildSummary; tree: ScriptNode[]; insights: InsightsPayload }) {
