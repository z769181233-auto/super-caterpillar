    ...
    return {
        ...
        flow: {
            nodes: [
                ...
                { key: 'SHOT_PLANNING', label: '分镜规划', status: 'PENDING', gate: { canRun: false }, actions: [] },
                { key: 'ASSET_GENERATION', label: '资产生成', status: 'PENDING', gate: { canRun: false }, actions: [] },
                { key: 'VIDEO_GENERATION', label: '视频生成', status: 'PENDING', gate: { canRun: false }, actions: [] },
                { key: 'COMPOSE_EXPORT', label: '合成导出', status: 'PENDING', gate: { canRun: false }, actions: [] },
            ],
        },
        next: {
            action: {
