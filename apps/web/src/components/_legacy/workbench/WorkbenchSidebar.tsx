...
export function WorkbenchSidebar({ currentModule, onModuleChange }: WorkbenchSidebarProps) {
    ...
    return (
        <div style={{
            ...
            <div style={{ padding: '0 20px 20px 20px', borderBottom: '1px solid #eee', marginBottom: '10px' }}>
                <h2 style={{ fontSize: '1.2rem', fontWeight: 700, margin: 0, color: '#333' }}>
                    控制中枢
                </h2>
                ...
                {menuItems.map((item) => (
                    <div
                        ...
                        style={{
                            ...
                            borderRight: currentModule === item.id ? '3px solid #1677ff' : '3px solid transparent',
                            display: 'flex',
                            alignItems: 'center',
                            gap: '10px',
                            fontSize: '0.95rem',
            ...
            <div style={{ padding: '20px', borderTop: '1px solid #eee', fontSize: '0.8rem', color: '#999', textAlign: 'center' }}>
