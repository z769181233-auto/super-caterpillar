        ...
        >
          ...
          <div
            style={{
              ...
              height: '200%',
              background:
                'radial-gradient(circle at center, hsla(var(--hsl-primary), 0.05) 0%, transparent 50%)',
              pointerEvents: 'none',
              zIndex: 0,
            }}
          ></div>
                  ...
                  {hasVideo && (
                    <div
                      style={{
                        fontSize: '0.75rem',
                        background:
                          'linear-gradient(135deg, hsl(var(--hsl-brand)), hsl(var(--hsl-secondary)))',
                        color: 'white',
                        padding: '2px 8px',
                        borderRadius: '12px',
                        fontWeight: 600,
            ...
            >
              ...
              >
                <div style={{ textAlign: 'center' }}>
                  <div style={{ fontSize: '0.75rem', color: 'hsl(var(--hsl-text-muted))' }}>
                    {t('stats.seasons')}
                  </div>
