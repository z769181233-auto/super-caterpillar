...
function mapAnalysisStatus(
  status: NovelAnalysisStatus | null | undefined
...
export default function DetailPanel({ selectedNode, analysisStatus, projectId }: DetailPanelProps) {
  ...
  const renderContent = () => {
    if (!selectedNode) {
      return (
        ...
        >
          <div className="text-4xl mb-4" style={{ filter: 'grayscale(1)' }}>
            📋
          </div>
      ...
      return (
        <div className="space-y-4">
          ...
          <div style={{ borderBottom: '1px solid var(--glass-border)', paddingBottom: '1rem' }}>
            <h3
              style={{ fontSize: '1.25rem', fontWeight: 700, color: 'hsl(var(--hsl-text-main))' }}
            >
              {t('season', { index: s.index ?? '' })}
            </h3>
            <div
              style={{
                height: '4px',
          ...
          <div className="space-y-3">
            ...
            <div style={sectionStyle}>
              ...
              <p
                style={{ ...valueStyle, fontFamily: 'monospace', color: 'hsl(var(--hsl-primary))' }}
              >
                {s.episodes?.length ?? 0}
              </p>
            </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div style={sectionStyle}>
              ...
              <p
                style={{ ...valueStyle, fontFamily: 'monospace', color: 'hsl(var(--hsl-success))' }}
              >
                {sc.shots?.length ?? 0}
              </p>
            </div>
            ...
            <div style={sectionStyle}>
              ...
              <div
                style={{
                  ...
                  padding: '2px 8px',
                  borderRadius: '4px',
                  background: 'hsla(var(--hsl-brand), 0.2)',
            ...
            {sh.params && Object.keys(sh.params).length > 0 && (
              <div style={sectionStyle}>
                ...
                <pre
                  style={{
                    fontSize: '0.75rem',
                    background: 'hsla(var(--hsl-bg-deep), 0.5)',
                    padding: '0.75rem',
                    borderRadius: 'var(--radius-md)',
  ...
  return (
    ...
    >
      {/* Body */}
      <div style={{ padding: '1.5rem', flex: 1, overflowY: 'auto' }}>{renderContent()}</div>
      {/* Bottom */}
      <div
        style={{
          marginTop: 'auto',
